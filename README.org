...
*** jQuery added as JavaScript dependency
When <HTML-DOCUMENT-WIDGET> is used jQuery is added automatically in
your HTML header. Please notice that jQuery is needed to work with
caveman2-widgets. *If you don't want to use the <HMTL-DOCUMENT-WIDGET>
please make sure that jQuery is added - specifically "$" is reachable
